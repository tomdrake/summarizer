summarizer = function(df, dependent, explanatory, explanatory.multi=NULL, random_effect=NULL, metrics=FALSE, weights=NULL){
  ...
  args = list(df=df, dependent=dependent, explanatory=explanatory, explanatory.multi=explanatory.multi,
              random_effect=random_effect, metrics=metrics, weights=weights)
